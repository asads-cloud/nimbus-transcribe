###############################################################################
# iam.tf — IAM Roles and Policies for AWS Batch
#
# This file sets up IAM roles used by AWS Batch:
# - Batch service role (for Batch itself)
# - ECS instance role + instance profile (for EC2 compute environments)
# - Batch job role (for running containers with S3 access)
###############################################################################
...
# Used by EC2 instances in Batch compute environments.
...
# Instance profile to associate role with EC2 hosts
...
# ── Batch Job Role ───────────────────────────────────────────────────────────
# Used by containers at runtime for S3 read/write access.
...
# Trust: allow ECS tasks to assume this role
